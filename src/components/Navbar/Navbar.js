        ...
        <nav>
          <ul className="navSectionLeft">
            <div className="navCategory">
              <div className="category" onMouseEnter={this.openNav}>
                카테고리
              </div>
              <img
                src="https://t1.kakaocdn.net/friends/new_store/2.0/pc/ico-header-triangle.png"
                alt=""
              />
            </div>
          ...
          <img
            className="kakaoFriends"
            src="https://t1.kakaocdn.net/friends/new_store/2.0/pc/friends-logo.png"
            alt=""
          />
          <div className="navSectionRight">
            <div className="searchBox">
              ...
              <img
                ...
                src="https://t1.kakaocdn.net/friends/new_store/2.0/pc/ico-header-search.png"
                alt=""
              />
            </div>
            <img
